...
level_2 = {
		...
		'unlock': 3}
level_3 = {
		'terrain': '../levels/3/level_6_terrain.csv',
		'coins':'../levels/3/level_6_coins.csv',
		'fg palms':'../levels/3/level_6_fg_palms.csv',
		'bg palms':'../levels/3/level_6_bg_palms.csv',
		'crates': '../levels/3/level_6_crates.csv',
		'enemies':'../levels/3/level_6_enemies.csv',
		'constraints':'../levels/3/level_6_constraints.csv',
		'player': '../levels/3/level_6_player.csv',
		'grass': '../levels/3/level_6_grass.csv',
		'node_pos': (610,350),
...
level_5 = {
		...
		'unlock': 6}
level_6 = {'terrain': '../levels/3/level_6_terrain.csv',
		'coins':'../levels/3/level_6_coins.csv',
		'fg palms':'../levels/3/level_6_fg_palms.csv',
		'bg palms':'../levels/3/level_6_bg_palms.csv',
		'crates': '../levels/3/level_6_crates.csv',
