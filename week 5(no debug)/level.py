...
from player import bullet_group
...
class Level:
    def __init__(self, current_level, surface, create_overworld, change_coins, change_health):
        ...
        self.bullet_sound = pygame.mixer.Sound('../audio/effects/bullet shot.mp3')
    ...
    def bullet_make(self):
        bullet_group.update()
        bullet_group.draw(self.display_surface)
        sprite = bullet_group.sprites()
    ...
    def check_colour_match(self):
        enemy_colour = Enemy(0,0,64).Colour()
        bullet_colour = Bullet(0,0,0,bullet_img,0).bullet_Colour()
        if enemy_colour == bullet_colour:
            return True
        if enemy_colour != bullet_colour:
            return False
    ...
    def check_enemy_collisions(self):
        ...
        if self.check_colour_match() == True:
        ...
        for sprites in collidable_sprites:
            for bullet in bullet_group:
                if pygame.sprite.collide_rect(sprites, bullet):
                    bullet.kill()
