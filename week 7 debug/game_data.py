...
level_5 = {
		...
		'unlock': 6}
level_6 = {'terrain': '../levels/3/level_6._terrain.csv',
		'coins':'../levels/3/level_6._coins.csv',
		'fg palms':'../levels/3/level_6._fg_palms.csv',
		'bg palms':'../levels/3/level_6._bg_palms.csv',
		'crates': '../levels/3/level_6._crates.csv',
		'enemies':'../levels/3/level_6._enemies.csv',
		'constraints':'../levels/3/level_6._constraints.csv',
		'player': '../levels/3/level_6._player.csv',
		'grass': '../levels/3/level_6._grass.csv',
		'node_pos': (1320,540),
		'node_graphics':'../graphics/overworld/5',
		'unlock': 6}
